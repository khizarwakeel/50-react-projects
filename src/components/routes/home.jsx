...
const Home = () => {
    return (
        <section>
            <Wrapper>
                <div>
                    <h1 className="text-center md:py-10 py-7 lg:text-4xl text-3xl font-bold text-[#017fa5]">25 React Projects</h1>
                </div>
                        ...
                        <div key={index} className="relative group">
                            <Link to={item.link} className="relative block border border-gray-200 rounded-xl shadow-xl">
                                <img
                                    ...
                                    alt={item.title}
                                    title={item.title}
                                    className="rounded-xl duration-500 w-full h-auto object-cover"
                                />
                                {/* Overlay */}
